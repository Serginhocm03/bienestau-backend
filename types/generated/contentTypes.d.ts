...
export interface ApiActionLineActionLine extends Struct.CollectionTypeSchema {
  collectionName: 'action_lines';
  info: {
    displayName: 'Action line';
    pluralName: 'action-lines';
    singularName: 'action-line';
  };
  options: {
  ...
  attributes: {
    ...
    content: Schema.Attribute.DynamicZone<
      [
        ...
        'section-components.accordion-section',
      ]
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    directors: Schema.Attribute.Relation<'oneToMany', 'api::person.person'>;
    header: Schema.Attribute.Component<'components.header', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::action-line.action-line'
    > &
      Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fecha_evento: Schema.Attribute.Date;
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    action_line: Schema.Attribute.Relation<
      'manyToOne',
      'api::action-line.action-line'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Component<'section-components.section', false> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReminderPageReminderPage extends Struct.SingleTypeSchema {
  collectionName: 'reminder_pages';
  info: {
    displayName: 'ReminderPage';
    pluralName: 'reminder-pages';
    singularName: 'reminder-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reminder-page.reminder-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiReminderReminder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    to: Schema.Attribute.Enumeration<['all', 'students', 'managers']> &
...
export interface ApiWelfareWelfare extends Struct.SingleTypeSchema {
  collectionName: 'welfares';
  info: {
    description: '';
    displayName: 'Welfare';
    pluralName: 'welfares';
    singularName: 'welfare';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    director: Schema.Attribute.Relation<'oneToOne', 'api::person.person'>;
    header: Schema.Attribute.Component<'components.header', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    notification_tokens: Schema.Attribute.Relation<
      'oneToMany',
      'api::notification-token.notification-token'
    >;
    password: Schema.Attribute.Password &
    ...
    >;
    token: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<['student', 'manager']> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::action-line.action-line': ApiActionLineActionLine;
      ...
      'api::reminder-page.reminder-page': ApiReminderPageReminderPage;
      'api::reminder.reminder': ApiReminderReminder;
      'api::welfare.welfare': ApiWelfareWelfare;
